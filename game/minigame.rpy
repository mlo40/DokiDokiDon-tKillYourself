...
screen game_scr():
    ...
    if timer_on:
        ...
        key "a" action Return("q")
        key "A" action Return("q")
        key "d" action Return("e")
        key "D" action Return("e")
    #
    ####
...
label race_game:
    ...
    #
    $ opponents = [
        {"car_name":"Mr. Red", "car":car, "car_color":"#c00", "opp_car_pos":(start_pos + finish_pos)/2, "opp_car_move":(-5, 0, 5, 6, 7, 8, 9, 10, 10)},
    ...
    "Let's begin! (push 'q' and 'e' buttons)"
    ...
    label race_game_loop:
        ...
        #
        elif res == "q" and last_pressed != "q":
            $ last_pressed = "q"
            $ car_pos += 10
        elif res == "e" and last_pressed != "e":
            $ last_pressed = "e"
            $ car_pos += 10
